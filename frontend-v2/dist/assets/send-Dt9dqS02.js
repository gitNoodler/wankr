import{cD as x,cG as d,dd as u,cH as b,cI as v,cK as F,c_ as D,cY as g,cT as j,dR as l,cJ as c,cM as z,cR as h,cP as H,cN as N,dz as q,cS as y,d2 as Q,d1 as Z,da as K,cE as Y,cF as J,dc as X,dY as L,dZ as M,cV as ee}from"./index-B21gR2C6.js";import"./index-D4CaxkMa.js";import"./index-Dzu0IODG.js";import{S as G}from"./SwapController-BMK2dMm_.js";const te=x`
  :host {
    width: 100%;
    height: 100px;
...
`;var B=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let R=class extends v{constructor(){super(...arguments),this.params=h.state.data?.send}render(){return c` <wui-text variant="sm-regular" color="secondary">Details</wui-text>
