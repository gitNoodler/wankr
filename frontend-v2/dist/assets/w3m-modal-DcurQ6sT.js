import{dz as x,d_ as te,cR as c,cT as ne,cD as g,cE as j,cH as m,cI as b,cJ as d,cG as l,dc as k,d0 as z,dd as u,cF as se,cY as f,cL as D,da as L,dW as le,dF as V,cV as U,dl as R,d4 as F,cO as ce,cS as A,dB as T,dT as q,db as de,cN as ie,d$ as ue,e0 as he}from"./index-BftUpkml.js";import{P as _}from"./index-CPSGKLLz.js";import{S as pe}from"./SwapController-xz_BV6Lm.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
